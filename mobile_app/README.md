...
### System Workflow
![System Workflow](assets/images/system_workflow.png)

```
┌─────────────────────────────────────────────────────────────────────────┐
│                    AMBIENT AI SCRIBE SYSTEM WORKFLOW                   │
└─────────────────────────────────────────────────────────────────────────┘

┌─────────────┐    ┌──────────────┐    ┌─────────────────┐    ┌─────────────┐
│   DOCTOR    │───▶│   AUDIO       │───▶│   TRANSCRIPTION  │───▶│   CLINICAL   │
│   INTERFACE  │    │   CAPTURE    │    │   SERVICE      │    │   NLP        │
│              │    │              │    │                │    │              │
│ • Login     │    │ • Recording  │    │ • Speech-to-  │    │ • SOAP       │
│ • Dashboard │    │ • Noise      │    │   Text         │    │   Generation  │
│ • Queue     │    │   Cancel     │    │ • Language     │    │ • Entity      │
│ • History   │    │              │    │   Detection    │    │   Extraction  │
└─────────────┘    └──────────────┘    └─────────────────┘    └─────────────┘
                           │                        │                        │
                           ▼                        ▼                        ▼
                   ┌──────────────┐    ┌─────────────────┐    ┌─────────────┐
                   ...
                   │   AI          │    │   LLM          │    │   MAPPING    │
                   │              │    │                │    │              │
                   │ • Streaming  │    │ • Medical     │    │ • Structured  │
                   │ • Hindi      │    │   Context     │    │   Data        │
                   │ • English    │    │ • SOAP         │    │ • Standards   │
                   │ • Code-mix  │    │ • Validation   │    │ • Export      │
                   └──────────────┘    └─────────────────┘    └─────────────┘
                           │                        │                        │
                           ▼                        ▼                        ▼
┌─────────────────────────────────────────────────────────────────────────┐
...
│                                                             │
│  ┌─────────────┐    ┌──────────────┐    ┌─────────────────┐    │
│  │   SOAP       │    │   FHIR        │    │   PRESCRIPTION   │    │
│  │   NOTES      │    │   BUNDLE      │    │   GENERATOR     │    │
│  │              │    │              │    │                │    │
│  │ • Subjective │    │ • Resources   │    │ • PDF Export     │    │
│  │ • Objective  │    │ • Patient     │    │ • Medication     │    │
│  │ • Assessment │    │ • Encounter   │    │ • Dosage         │    │
...
│                                                             │
│  ┌─────────────┐    ┌──────────────┐    ┌─────────────────┐    │
│  │   LOCAL     │    │   SUPABASE    │    │   EHR/HIS       │    │
│  │   STORAGE    │    │   DATABASE     │    │   INTEGRATION    │    │
│  │              │    │              │    │                │    │
│  │ • Offline    │    │ • Patients    │    │ • API Export     │    │
│  │ • Cache      │    │ • Queue       │    │ • HL7/FHIR      │    │
│  │ • Sessions   │    │ • Consultations│    │ • Real-time      │    │
│  └─────────────┘    └──────────────┘    └─────────────────┘    │
│                                                             │
└─────────────────────────────────────────────────────────────────────────┘
```
